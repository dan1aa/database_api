...
const event_feedback_request_shema_1 = require("@request-schemas/event-feedback.request-shema");
const createEventFeedbacks = {
    ...
    requestBody: {
        content: {
            'application/json': {
                schema: (0, joi_to_swagger_1.default)(event_feedback_request_shema_1.createEventFeedbacksSheme).swagger,
            },
        },
        required: true,
    },
...
const updateEventFeedbackById = {
    ...
    requestBody: {
        content: {
            'application/json': {
                schema: (0, joi_to_swagger_1.default)(event_feedback_request_shema_1.updateEventFeedbackSheme).swagger,
            },
        },
        required: true,
    },
