...
const feedback_on_facilitator_request_schema_1 = require("@request-schemas/feedback-on-facilitator.request-schema");
...
const createFeedbacksOnFacilitator = {
    ...
    requestBody: {
        content: {
            'application/json': {
                schema: (0, joi_to_swagger_1.default)(feedback_on_facilitator_request_schema_1.createFeedbacksOnFacilitatorScheme).swagger,
            },
        },
        required: true,
    },
...
const updateFeedbackOnFacilitatorById = {
    ...
    requestBody: {
        content: {
            'application/json': {
                schema: (0, joi_to_swagger_1.default)(feedback_on_facilitator_request_schema_1.updateFeedbackOnFacilitatorScheme).swagger,
            },
        },
        required: true,
    },
