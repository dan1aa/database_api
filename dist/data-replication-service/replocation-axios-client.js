...
const replicateData = (tag, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield axios_1.default.post(process.env.GOOGLE_SHEETS_DATABASE_BASE_URL, {
            tag,
            data
        });
    }
